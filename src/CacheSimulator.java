public class CacheSimulator {
    ...
    public CacheSimulator(int blockSize,boolean isHarvard, int associativity, WritePolicy writeHit, int... cSizes) {
        this.isHarvard = isHarvard;
//        if (isSplit())
//            System.out.println(0 / 0);
        config = new Configuration(blockSize, writeHit , associativity);
        if (isSplit()) {
